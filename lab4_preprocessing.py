...
# Based on "Python Machine Learning, 2nd Edition" (Ch. 4)
# ------------------------------------------------------------------
# Work through the cells from top to bottom. Read the instructions
# in comments, run the code, and complete the TODOs.
#
# TIP (VS Code):
# - Open this file in VS Code.
# - Use the 'Run Cell' links that appear above each '# %%' cell,
#   or press Shift+Enter to run the current cell in the Interactive window.
# - Plots will appear inline; saved copies go to ./outputs/
#
# Keep notes on your observations and answers; you'll add them to your README
